export const translations = {
  tr: {
    ...
    contactDesc: "Etkinlikler, söyleşiler, iş birlikleri ve genel bilgi talepleriniz için bize ulaşabilirsiniz. Bodrum’un kültürel mirasını birlikte yaşatalım.",
    nameLabel: "Ad Soyad",
    emailLabel: "E-Posta",
    subjectLabel: "Konu",
  ...
  en: {
    ...
    contactDesc: "Reach out to us for cultural programs, panel proposals, donations, and general inquiries. Let's preserve Bodrum's cultural heritage together.",
    nameLabel: "Full Name",
